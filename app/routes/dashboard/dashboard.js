angular.module('app.admin.dashboard', []).component('dashboard', {
  ...
  controller: function ($scope) {
    ...
    $scope.data = [{
      distance: 3.24,
      time: 34,
      date: new Date("May 01, 2017")
    }, {
      distance: 4.24,
      time: 38,
      date: new Date("May 12, 2017")
    }, {
      distance: 3.67,
      time: 37,
      date: new Date("May 23, 2017")
    }, {
      distance: 6.50,
      time: 59,
      date: new Date("June 02, 2017")
    }, {
      distance: 5.64,
      time: 52,
      date: new Date("June 12, 2017")
    }, {
      distance: 4.90,
      time: 45,
      ...
      distance: 10.1,
      time: 98,
      date: new Date("August 11, 2017")
    }, {
      distance: 7.56,
      time: 59,
      date: new Date("August 27, 2017")
    }, {
      distance: 9.3,
      time: 84,
      ...
      distance: 6.7,
      time: 54,
      date: new Date("September 2, 2017")
    }, {
      distance: 11.43,
      time: 108,
      ...
      distance: 4.5,
      time: 34,
      date: new Date("September 22, 2017")
    }, {
      distance: 13.1,
      time: 128,
      date: new Date("October 18, 2017")
    }, {
      distance: 6.4,
      time: 58,
      date: new Date("October 26, 2017")
    }]
